...
LABEL repository="https://github.com/suzutan/php-app"
...
RUN docker-php-ext-install fileinfo mysqli mbstring mcrypt pdo pdo_mysql pdo_sqlite zip hash zlib json curl
CMD ["php-fpm"]
